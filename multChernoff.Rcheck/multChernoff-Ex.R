pkgname <- "multChernoff"
source(file.path(R.home("share"), "R", "examples-header.R"))
options(warn = 1)
base::assign(".ExTimings", "multChernoff-Ex.timings", pos = 'CheckExEnv')
...
### Name: criticalValue
### Title: Critical value x such that P(LRT > x) <= p
...
base::cat("criticalValue", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("tailProbBound")
### * tailProbBound
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: tailProbBound
### Title: Tail bound on P(LRT > x)
### Aliases: tailProbBound
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("tailProbBound", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
### * <FOOTER>
###
cleanEx()
options(digits = 7L)
